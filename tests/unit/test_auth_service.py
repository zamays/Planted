...
class TestPasswordChange:
    ...
    def test_change_password_success(self, auth_service):
        ...
        success = auth_service.change_password(user_id, "oldpassword", "newpassword123")
    ...
    def test_change_password_wrong_current_password(self, auth_service):
        ...
        user_id = auth_service.register_user("testuser", "test@example.com", "password123")
        success = auth_service.change_password(user_id, "wrongpassword", "newpassword123")
    ...
    def test_change_password_nonexistent_user(self, auth_service):
        ...
        success = auth_service.change_password(999999, "oldpass", "newpass123")
        assert success is False
...
class TestEmailChange:
    ...
    def test_change_email_success(self, auth_service):
        """Test successful email change."""
        user_id = auth_service.register_user("testuser", "old@example.com", "password123")
        success = auth_service.change_email(user_id, "new@example.com")
        assert success is True
    ...
    def test_change_email_duplicate(self, auth_service):
        ...
        user_id2 = auth_service.register_user("testuser2", "user2@example.com", "password456")

        success = auth_service.change_email(user_id2, "user1@example.com")
        assert success is False
